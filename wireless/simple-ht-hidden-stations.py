...
def main(argv):
	...
	cmd.AddValue ("enableRts", "Enable RTS/CTS") # True: RTS/CTS enabled; False: RTS/CTS disabled
	...
	wifi.SetRemoteStationManager ("ns3::ConstantRateWifiManager", "DataMode", ns.core.StringValue ("HtMcs7"), "ControlMode", ns.core.StringValue ("HtMcs0"))
 	...
 	mobility.Install (wifiApNode)
  	...
  	myClient = ns.applications.UdpClientHelper (ApInterface.GetAddress (0), 9)
  	myClient.SetAttribute ("MaxPackets", ns.core.UintegerValue (4294967295))
  	myClient.SetAttribute ("Interval", ns.core.TimeValue (ns.core.Time ("0.00002")))
  	myClient.SetAttribute ("PacketSize", ns.core.UintegerValue (payloadSize))
  
  	clientApp1 = myClient.Install (wifiStaNodes)
